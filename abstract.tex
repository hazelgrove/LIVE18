...
of type and binding errors. Consequently,    
...
%
Incomplete functional programs are modeled, following the recent work by \citet{popl-paper}, as expressions with \emph{holes}, 
...
several existing systems, evaluation proceeds around holes and 
tracks the 
closure around each hole instance as it flows through the remainder of the program.
Hole closures enable a \emph{fill-and-resume} operation that 
...
We discuss two examples of such editor services. 
...
Second, we discuss early work on how hole closures support \emph{live palettes}---user interfaces, which can themselves contain holes, that the programmer can directly manipulate to fill an expression hole of a corresponding type. 
