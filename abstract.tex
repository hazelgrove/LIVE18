...
The \Hazel live functional programming environment addresses this ``{gap problem}'' from first principles: \Hazel assigns rich static and dynamic meaning to every incomplete program that can be constructed using \Hazel's language of structured edit actions. 
%
Incomplete programs are modeled, following the recent work by \citet{popl-paper}, as expressions with \emph{holes}. Empty holes stand for missing expressions or types, and  non-empty holes 
