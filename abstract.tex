...
Finally, we discuss how hole closures allow \Hazel to support \emph{live projections}---user interfaces that the programmer can directly manipulate to fill a hole within a \Hazel
program. 
