...
user interface, rather than by constructing a \li{Color} value  
...
The program is initially evaluated as if the hole where the palette name appears, here \li{$grade_cutoffs}, is empty. 
